...
global $product;
$product_sku = ($sku = $product->get_sku()) ? $sku : esc_html__('N/A', 'neotech');
...
<div class="product_meta">
    ...
    <?php echo wc_get_product_category_list( $product->get_id(), $separator , '<span class="posted_in">' . _n( 'Category:', 'Categories:', count( $product->get_category_ids() ), 'neotech' ) . '  ', '</span>' ); ?>

	<?php echo wc_get_product_tag_list( $product->get_id(), $separator , '<span class="tagged_as">' . _n( 'Tag:', 'Tags:', count( $product->get_tag_ids() ), 'neotech' ) . '  ', '</span>' ); ?>

    <?php if (wc_product_sku_enabled() && ($product->get_sku() || $product->is_type('variable'))) : ?>
        <span class="sku_wrapper"><?php esc_html_e('SKU:', 'neotech'); ?> <span class="sku"><?php echo esc_html($sku = $product->get_sku()) ? $sku : esc_html__('N/A', 'neotech'); ?></span></span>
    <?php endif; ?>

	<?php do_action( 'woocommerce_product_meta_end' ); ?>
    <div class="pbr-social-share">
        <?php esc_html_e('share:', 'neotech'); ?>
