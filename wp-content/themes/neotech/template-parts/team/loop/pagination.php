...
$total   = isset( $total ) ? $total : neotech_get_team_loop_prop( 'total_pages' );
$current = isset( $current ) ? $current : neotech_get_team_loop_prop( 'current_page' );
...
?>
<nav class="team-pagination pagination">
	<?php
	echo paginate_links(
		apply_filters(
			'team_pagination_args',
            array( // WPCS: XSS ok.
                'base'      => $base,
                'format'    => $format,
                'add_args'  => false,
