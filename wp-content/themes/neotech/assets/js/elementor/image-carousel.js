    ...
    $(window).on('elementor/frontend/init', () => {
        const addHandler = ($element) => {
            if(!$element.hasClass('smoot-carousel-yes')) {
                ...
                let $list = $tickerWrapper.find(".neotech-con");
                ...
                $list.find(".neotech-con-inner").each(function (i) {
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/neotech-image-carousel.default', addHandler);
    })
})(jQuery);
