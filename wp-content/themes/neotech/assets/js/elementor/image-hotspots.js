(function ($) {
    ...
    $(window).on('elementor/frontend/init', () => {
        const addHandler = ($element) => {
            if ($element.hasClass('image-hotspots-type-slider')) {
                ...
                var active_hotspot = ($index) => {
                    $element.find('.neotech-image-hotspots-main-icons').removeClass('actived');
                    $element.find('.neotech-image-hotspots-main-icons[data-index="'+$index+'"').addClass('actived');
                }
                ...
                $element.on("swiperInit", function(e, slider){
                    ...
                    $element.find('.neotech-image-hotspots-main-icons').on('click', function(e) {
                        e.preventDefault();
                ...
                let imgHotspotsElem = $element.find('.neotech-image-hotspots-container'),
                ...
                if (imgHotspotsSettings['trigger'] === 'click') {
                    triggerClick = true;
                    triggerHover = false;
                    if ($element.find('.neotech-image-hotspots-accordion').length) {
                        $element.find('.neotech-image-hotspots-main-icons').on('click', function () {
                    ...
                    triggerHover = true;
                    if ($element.find('.neotech-image-hotspots-accordion').length) {
                        $element.find('.neotech-image-hotspots-main-icons').on('mouseover', function () {
                            let $tab = $($(this).data('tab'));
                            if (!$tab.hasClass('elementor-active')) {
                                $tabs.find('.elementor-tab-title').removeClass('elementor-active');
        ...
        elementorFrontend.hooks.addAction('frontend/element_ready/neotech-image-hotspots.default', addHandler);
    });
