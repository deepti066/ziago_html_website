<?php
/**
 * Neotech WooCommerce Adjacent Products Class
 *
 * @package  aro
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Neotech_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Neotech WooCommerce Adjacent Products Class
	 */
	class Neotech_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'neotech_woocommerce_adjacent_query_args', $args ) );
