<?php
/**
 * Neotech_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        Neotech_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Neotech_Product_Brand_List_Walker', false)) :

	class Neotech_Product_Brand_List_Walker extends Walker {
