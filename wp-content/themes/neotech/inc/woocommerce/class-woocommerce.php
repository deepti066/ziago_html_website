...
if (!class_exists('Neotech_WooCommerce')) :

    /**
     * The Neotech WooCommerce Integration class
     */
    class Neotech_WooCommerce {
        ...
        public function __construct() {
            ...
            add_filter('neotech_theme_sidebar', array($this, 'set_sidebar'), 99);
            ...
            add_filter('neotech_register_nav_menus', [$this, 'add_location_menu']);
            ...
            add_filter('woocommerce_single_product_image_gallery_classes', function ($wrapper_classes) {
                $wrapper_classes[] = 'woocommerce-product-gallery-' . neotech_get_theme_option('single_product_gallery_layout', 'horizontal');

                if (neotech_get_theme_option('single_product_gallery_layout', 'horizontal') == 'gallery') {
            ...
            add_action('neotech_after_page_content', [$this, 'woo_add_cross_sells_cart_page']);
        ...
        public function custom_woosw_button_text($btn_text) {
            $btn_text = __('Add to wishlist', 'neotech');
        ...
        public function add_extra_item_to_nav_menu($items, $args) {
            if ($args->theme_location == 'my-account') {
                $items .= '<li><a href="' . esc_url(wp_logout_url(home_url())) . '">' . esc_html__('Logout', 'neotech') . '</a></li>';
            }
        ...
        public function add_location_menu($locations) {
            $locations['my-account'] = esc_html__('My Account', 'neotech');
        ...
        public function setup() {
            add_theme_support(
                'woocommerce', apply_filters(
                    'neotech_woocommerce_args', array(
                        'product_grid' => array(
                            'default_columns' => 4,
                            'default_rows'    => 4,
                            'min_columns'     => 1,
            ...
            /**
             * Add 'neotech_woocommerce_setup' action.
             *
             * @since  2.4.0
             */
            do_action('neotech_woocommerce_setup');
        }


        public function action_woocommerce_before_template_part($template_name, $template_path, $located, $args) {
            $product_style = neotech_get_theme_option('wocommerce_block_style', 0);
        ...
        public function shortcode_loop_end($atts = array()) {
            ...
            if (isset($atts['style']) && $atts['style'] !== '') {
                ...
                if (isset($atts['show_time_sale']) && $atts['show_time_sale'] == true) {
                    $function_to_call('woocommerce_before_shop_loop_item_title', 'neotech_woocommerce_time_sale', 15);
                }
                if (isset($atts['show_deal_sold']) && $atts['show_deal_sold'] == true) {
                    $function_to_call('woocommerce_after_shop_loop_item_title', 'neotech_woocommerce_deal_progress', 70);
                }
            }
        ...
        public function shortcode_loop_start($atts = array()) {
            ...
            if (isset($atts['product_layout']) && $atts['product_layout'] == 'list') {
                ...
                $function_to_call('neotech_shop_layout', 'neotech_wcc_grid_layout_loop', 10);
                add_filter('neotech_shop_layout', 'neotech_wcc_list_layout_loop', 10, 1);
                add_filter( 'woocommerce_post_class', function($classes, $product) {return $classes;} , 10, 2);
            } 
            else {
                add_filter('neotech_shop_layout', 'neotech_wcc_grid_layout_loop', 10, 1);
                add_filter( 'woocommerce_post_class', function($classes, $product) {return $classes;} , 10, 2);
            }
            ...
            if (isset($template_custom)) {
                ...
                if (isset($atts['show_time_sale']) && $atts['show_time_sale'] == true) {
                    add_action('woocommerce_before_shop_loop_item_title', 'neotech_woocommerce_time_sale', 15);
                }
                if (isset($atts['show_deal_sold']) && $atts['show_deal_sold'] == true) {
                    add_action('woocommerce_after_shop_loop_item_title', 'neotech_woocommerce_deal_progress', 70);
                }
            }
         ...
         * @deprecated 2.3.1
         */
        public function set_neotech_style_theme_mods() {
        ...
        public function woocommerce_body_class($classes) {
            ...
            $style        = neotech_get_theme_option('wocommerce_block_style', 1);
            $layout       = neotech_get_theme_option('woocommerce_archive_layout', 'default');
            $sidebar      = neotech_get_theme_option('woocommerce_archive_sidebar', 'left');
            $single_style = neotech_get_theme_option('wocommerce_single_style', 1);
            $classes[]    = 'product-block-style-' . $style;
            $classes[]    = 'product-single-style-' . $single_style;


            if (neotech_is_product_archive()) {
                // $classes   = array_diff($classes, array(
                //     'neotech-sidebar-left', 'neotech-sidebar-right', 'neotech-full-width-content'
                // ));
                $classes[] = 'neotech-archive-product';
                ...
                if (is_active_sidebar('sidebar-woocommerce-shop')) {
                    ...
                    if ($layout == 'drawing') {
                        ...
                        // if ($sidebar == 'left') {
                            // $classes[] = 'neotech-sidebar-left';
                            $classes[] = 'neotech-drawing-side';
                            add_filter('neotech_sidebar_class', function($sidebarClass) {
                    ...
                    if ($layout == 'canvas') {
                        $classes[] = 'neotech-full-width-content shop_filter_canvas';
                    }

                    if ($layout == 'dropdown') {
                        $classes[] = 'neotech-full-width-content shop_filter_dropdown';
                    }
                } else {
            ...
            if (is_product()) {
                $classes[] = 'neotech-full-width-content';
                $classes[] = 'single-product-' . neotech_get_theme_option('single_product_gallery_layout', 'horizontal');
                $classes[] = 'single-product-tab-' . neotech_get_theme_option('single_product_tab_layout', 'default');
                
                $show_sidebar = neotech_get_theme_option('wocommerce_single_sidebar', '');
        ...
        public function woocommerce_scripts() {
            ...
            //register_style
            wp_register_style('neotech-woocommerce-style', get_template_directory_uri() . '/assets/css/woocommerce/woocommerce.css', array(), $neotech_version);
            wp_register_style('neotech-woocommerce-legacy', get_template_directory_uri() . '/assets/css/woocommerce/woocommerce-legacy.css', array(), $neotech_version);
            //register_script
            wp_register_script('neotech-header-cart', get_template_directory_uri() . '/assets/js/woocommerce/header-cart' . $suffix . '.js', array(), $neotech_version, true);
            wp_register_script('neotech-products-ajax-search', get_template_directory_uri() . '/assets/js/woocommerce/product-ajax-search' . $suffix . '.js', array('jquery', 'tooltipster'), $neotech_version, true);
            wp_register_script('neotech-products', get_template_directory_uri() . '/assets/js/woocommerce/main' . $suffix . '.js', array('jquery'), $neotech_version, true);
            wp_register_script('neotech-input-quantity', get_template_directory_uri() . '/assets/js/woocommerce/quantity' . $suffix . '.js', array('jquery'), $neotech_version, true);
            wp_register_script('neotech-cart-canvas', get_template_directory_uri() . '/assets/js/woocommerce/cart-canvas' . $suffix . '.js', array(), $neotech_version, true);
            wp_register_script('neotech-off-canvas', get_template_directory_uri() . '/assets/js/woocommerce/off-canvas' . $suffix . '.js', array(), $neotech_version, true);
            wp_register_script('neotech-sticky-add-to-cart', get_template_directory_uri() . '/assets/js/sticky-add-to-cart' . $suffix . '.js', array(), $neotech_version, true);
            wp_enqueue_script('neotech-single-product', get_template_directory_uri() . '/assets/js/woocommerce/single' . $suffix . '.js', array(
                'jquery',
                'swiper',
                'sticky-kit',
                'magnific-popup'
            ...
            //enqueue_style
            wp_enqueue_style('neotech-woocommerce-style');
            wp_style_add_data('neotech-woocommerce-style', 'rtl', 'replace');
            // QuickView
            wp_dequeue_style('yith-quick-view');
            wp_enqueue_script('neotech-header-cart');

            //enqueue_script
            wp_enqueue_script('neotech-products-ajax-search');
            wp_enqueue_script('neotech-products');
            wp_enqueue_script('neotech-input-quantity');
            wp_enqueue_script('neotech-cart-canvas');

            if (defined('WC_VERSION') && version_compare(WC_VERSION, '3.3', '<')) {
                wp_enqueue_style('neotech-woocommerce-legacy');
                wp_style_add_data('neotech-woocommerce-legacy', 'rtl', 'replace');
            }

            if (is_shop() || is_product() || is_product_taxonomy()) {
                wp_enqueue_script('neotech-shop-select', get_template_directory_uri() . '/assets/js/woocommerce/shop-select' . $suffix . '.js', array('jquery'), $neotech_version, true);
                wp_enqueue_script('neotech-shop', get_template_directory_uri() . '/assets/js/woocommerce/shop' . $suffix . '.js', array(
                    'jquery', 'neotech-waypoints'
                ), $neotech_version, true);
            }
            if (is_shop() || is_product() || is_product_taxonomy() || neotech_elementor_check_type('neotech-products')) {
            ...
            if (is_active_sidebar('sidebar-woocommerce-shop')) {
                wp_enqueue_script('neotech-off-canvas');
            }

            if (is_product() || is_cart()) {
                wp_enqueue_script('neotech-countdown');
                wp_enqueue_style('neotech-sticky-add-to-cart');
                wp_enqueue_style('magnific-popup');
                wp_enqueue_script('magnific-popup');
                ...
                wp_enqueue_script('neotech-single-product');
            }
        }
        ...
        public function related_products_args($args) {
            ...
            $args = apply_filters(
                'neotech_related_products_args', array(
        ...
        public function upsell_products_args() {
            $args = apply_filters(
                'neotech_upsell_products_args', array(
                    'columns' => 4,
                )
            );
            return $args;
        ...
        public function thumbnail_columns() {
            $columns = neotech_get_theme_option('single_product_gallery_column', 3);

            if (neotech_get_theme_option('single_product_gallery_layout', 'horizontal') == 'vertical') {
                $columns = 1;
            }
            if (neotech_get_theme_option('single_product_gallery_layout', 'horizontal') == 'right_vertical') {
                $columns = 1;
            }
            if (neotech_get_theme_option('single_product_gallery_layout', 'horizontal') == 'gallery') {
                $columns = 1;
            ...
            return intval(apply_filters('neotech_product_thumbnail_columns', $columns));
        }
        ...
        public function customize_rating_html($html, $rating, $count) {
            if ( 0 < $rating ) {
                ...
                $label = sprintf( __( 'Rated %s out of 5', 'neotech' ), $rating );
        ...
        public function products_per_page() {
            return intval(apply_filters('neotech_products_per_page', 12));
        }
        ...
        public function widgets_init() {
            register_sidebar(array(
                'name'          => esc_html__('WooCommerce Shop', 'neotech'),
                'id'            => 'sidebar-woocommerce-shop',
                'description'   => esc_html__('Add widgets here to appear in your sidebar on blog posts and archive pages.', 'neotech'),
                'before_widget' => '<div id="%1$s" class="widget %2$s neotech-widget-woocommerce">',
                'after_widget'  => '</div>',
            ...
            register_sidebar(array(
                'name'          => esc_html__('WooCommerce Single Product', 'neotech'),
                'id'            => 'sidebar-woocommerce-single',
                'description'   => esc_html__('Add widgets here to appear in your sidebar on single product page.', 'neotech'),
                'before_widget' => '<div id="%1$s" class="widget %2$s neotech-widget-woocommerce">',
                'after_widget'  => '</div>',
                'before_title'  => '<div class="gamma widget-title">',
                'after_title'   => '</div>',
        ...
        public function add_wrapper_filter_widget_woo($widget_title, $instance, $id_base) {
            $base_filter_ids = [
                ...
                'neotech_woocommerce_layered_nav',
                'woocommerce_product_brands',
            ];
        
            if (in_array($id_base, $base_filter_ids)) {
                $widget_title = '<span class="neotech_title_filter">'.$widget_title.'</span>';
            }
...
return new Neotech_WooCommerce();
