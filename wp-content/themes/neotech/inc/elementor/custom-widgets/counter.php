...
add_action( 'elementor/element/counter/section_counter/before_section_end', function ($element, $args ) {
    ...
    $element->add_control(
        'counter_style',
        [
            'label' => esc_html__( 'Counter Style', 'neotech' ),
...
// Widget_Counter
class Neotech_Elementor_Counter extends Widget_Counter {
    /**
...
$widgets_manager->register(new Neotech_Elementor_Counter());