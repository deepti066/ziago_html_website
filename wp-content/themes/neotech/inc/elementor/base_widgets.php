...
abstract class Neotech_Base_Widgets extends Widget_Base {
    /**
    ...
    protected function get_controls_column($condition = false) {
        ...
        $args_column = [
            'label' => esc_html__('Column Options', 'neotech')
        ];
        if ($condition) {
    ...
    protected function get_control_carousel_options($condition = false, $alway_show = false) {
        $args_caroseul_section = [
            'label' => esc_html__('Caroseul Options', 'neotech'),
        ];
        if ($condition) {
        ...
        if ($alway_show) {
            $this->add_control(
                'enable_carousel',
                [
                    'label' => esc_html__( 'Enable Carousel', 'neotech' ),
        ...
        $this->add_control(
            'swiper_overflow',
            [
                'label'              => esc_html__('Overflow', 'neotech'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'none',
                'options'            => [
                    'none'  => esc_html__('None', 'neotech'),
                    'left'  => esc_html__('Overflow to the left', 'neotech'),
                    'right' => esc_html__('Overflow to the right', 'neotech'),
                    'center' => esc_html__('Overflow to the center', 'neotech'),
                ],
                'frontend_available' => true,
        ...
        $this->add_control(
            'navigation',
            [
                'label'              => esc_html__('Navigation', 'neotech'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'both',
                'options'            => [
                    'both'   => esc_html__('Arrows and Dots', 'neotech'),
                    'arrows' => esc_html__('Arrows', 'neotech'),
                    'dots'   => esc_html__('Dots', 'neotech'),
                    'none'   => esc_html__('None', 'neotech'),
                ],
                'frontend_available' => true,
                'condition'          => [
        ...
        $this->add_control('custom_navigation',
            [
                'label'              => esc_html__('Custom Navigation', 'neotech'),
                'type'               => Controls_Manager::SWITCHER,
                'frontend_available' => true,
                'conditions'         => [
                    'relation' => 'and',
        ...
        $this->add_control(
            ...
            [
                'label'              => esc_html__('Class Navigation Previous', 'neotech'),
        ...
        $this->add_control(
            ...
            [
                'label'              => esc_html__('Class Navigation Next', 'neotech'),
                'type'               => Controls_Manager::TEXT,
                'frontend_available' => true,
                'conditions'         => [
                    'relation' => 'and',
        ...
        $this->add_control(
            ...
            [
                'label'            => esc_html__('Previous Arrow Icon', 'neotech'),
        ...
        $this->add_control(
            ...
            [
                'label'            => esc_html__('Next Arrow Icon', 'neotech'),
                'type'             => Controls_Manager::ICONS,
                'fa4compatibility' => 'icon',
                'skin'             => 'inline',
                'label_block'      => false,
    ...
    protected function get_control_carousel_additional($condition = false) {
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => esc_html__('Additional Options', 'neotech'),
        ...
        $this->add_control(
            'lazyload',
            [
                'label'              => esc_html__('Lazyload', 'neotech'),
                'type'               => Controls_Manager::SWITCHER,
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'autoplay',
            [
                'label'              => esc_html__('Autoplay', 'neotech'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'yes',
                'options'            => [
        ...
        $this->add_control(
            'pause_on_hover',
            [
                'label'              => esc_html__('Pause on Hover', 'neotech'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'yes',
                'options'            => [
                    'yes' => esc_html__('Yes', 'neotech'),
        ...
        $this->add_control(
            ...
            [
                'label'              => esc_html__('Pause on Interaction', 'neotech'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'yes',
                'options'            => [
                    'yes' => esc_html__('Yes', 'neotech'),
        ...
        $this->add_control(
            'autoplay_speed',
            [
                'label'              => esc_html__('Autoplay Speed', 'neotech'),
        ...
        $this->add_control(
            'infinite',
            [
                'label'              => esc_html__('Infinite Loop', 'neotech'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'yes',
                'options'            => [
                    'yes' => esc_html__('Yes', 'neotech'),
        ...
        $this->add_control(
            'effect',
            [
                'label'              => esc_html__('Effect', 'neotech'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'slide',
                'options'            => [
        ...
        $this->add_control(
            'speed',
            [
                'label'              => esc_html__('Animation Speed', 'neotech'),
                'type'               => Controls_Manager::NUMBER,
                'default'            => 500,
                'render_type'        => 'none',
                'frontend_available' => true,
        ...
        $this->add_control(
            'direction',
            [
                'label'   => esc_html__('Direction', 'neotech'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'ltr',
                'options' => [
                    'ltr' => esc_html__('Left', 'neotech'),
                    'rtl' => esc_html__('Right', 'neotech'),
                    'ctl' => esc_html__('Center', 'neotech'),
                ],
            ]
        );
    ...
    protected function get_control_carousel_style_navigation($condition = false) {
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Arrows', 'neotech'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .neotech-swiper-wrapper .elementor-swiper-button i' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'navigation' => ['arrows', 'both'],
                ],
        ...
        $this->add_control(
            'arrows_next_heading',
            [
                'label'     => esc_html__('Next button', 'neotech'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
                    'navigation' => ['arrows', 'both'],
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__('Next Vertical', 'neotech'),
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__('Next Horizontal', 'neotech'),
                'type'         => Controls_Manager::CHOOSE,
                'label_block'  => false,
                'options'      => [
                    'left'  => [
        ...
        $this->add_control(
            'arrows_prev_heading',
            [
                'label'     => esc_html__('Prev button', 'neotech'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
                    'navigation' => ['arrows', 'both'],
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__('Prev Vertical', 'neotech'),
                'type'         => Controls_Manager::CHOOSE,
                'label_block'  => false,
                'render_type'  => 'ui',
                'options'      => [
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__('Prev Horizontal', 'neotech'),
                'type'         => Controls_Manager::CHOOSE,
                'label_block'  => false,
                'options'      => [
                    'left'  => [
        ...
        $this->add_control(
            'dots_position',
            [
                'label'        => esc_html__('Position', 'neotech'),
                'type'         => Controls_Manager::SELECT,
                'default'      => 'outside',
                'options'      => [
                    'outside' => esc_html__('Outside', 'neotech'),
                    'inside'  => esc_html__('Inside', 'neotech'),
                ],
        ...
        $this->add_control(
            'dots_color',
            [
                'label'     => esc_html__('Active Color', 'neotech'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'carousel_dots',
            [
                'label'      => esc_html__('Carousel Dots', 'neotech'),
        ...
        $this->add_control(
            'style_dot',
            [
                'label'        => esc_html__('Style Dot', 'neotech'),
                'type'         => Controls_Manager::SELECT,
                'options'      => [
                    'style-1' => esc_html__('Style 1', 'neotech'),
                    'style-2' => esc_html__('Style 2', 'neotech'),
                    'style-3' => esc_html__('Style 3', 'neotech'),
                ],
                'default'      => 'style-1',
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__('Activate', 'neotech'),
            ]
        );
        ...
        $this->add_responsive_control(
            'Alignment_text',
            [
                'label'     => esc_html__('Alignment text', 'neotech'),
                'type'      => Controls_Manager::CHOOSE,
                'options'   => [
                    'flex-start' => [
                        'title' => esc_html__('Left', 'neotech'),
    ...
    protected function get_data_elementor_columns() {
        ...
        $settings = $this->get_settings_for_display();
        //item
        $this->add_render_attribute('wrapper', 'class', 'neotech-wrapper');
        $this->add_render_attribute('container', 'class', 'neotech-con');
        $this->add_render_attribute('inner', 'class', 'neotech-con-inner');
        if ($settings['enable_carousel'] === 'yes') {
            $swiper_class = Plugin::$instance->experiments->is_feature_active('e_swiper_latest') ? 'swiper' : 'swiper-container';
            $this->add_render_attribute('wrapper', 'class', 'neotech-swiper-wrapper swiper');
            $this->add_render_attribute('container', 'class', [$swiper_class, 'neotech-swiper']);
    ...
    protected function get_control_pagination() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'numbers'               => esc_html__('Numbers', 'neotech'),
                    'prev_next'             => esc_html__('Previous/Next', 'neotech'),
                    'numbers_and_prev_next' => esc_html__('Numbers', 'neotech') . ' + ' . esc_html__('Previous/Next', 'neotech'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Page Limit', 'neotech'),
                'default'   => '5',
                'condition' => [
                    'pagination_type!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Shorten', 'neotech'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => '',
                'condition' => [
                    'pagination_type' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Previous Label', 'neotech'),
                'default'   => esc_html__('&laquo; Previous', 'neotech'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Next Label', 'neotech'),
                'default'   => esc_html__('Next &raquo;', 'neotech'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
    ...
    protected function render_loop_footer() {
        ...
        if ($has_numbers) {
            $links = paginate_links([
                ...
                'before_page_number' => '<span class="elementor-screen-only">' . esc_html__('Page', 'neotech') . '</span>',
            ]);
        }
        ...
        <div class="pagination">
            <nav class="elementor-pagination" aria-label="<?php esc_attr_e('Pagination', 'neotech'); ?>">
