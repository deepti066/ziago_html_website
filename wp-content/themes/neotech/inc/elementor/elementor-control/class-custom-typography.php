 ...
 * @since 1.0.0
 */
class Neotech_Group_Control_Typography extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['font_family'] = [
			'label' => esc_html_x( 'Family', 'Typography Control', 'neotech' ),
		...
		$fields['font_size'] = [
			'label' => esc_html_x( 'Size', 'Typography Control', 'neotech' ),
		...
		$fields['line'] = [
			'label' => esc_html_x( 'Line Text', 'Typography Control', 'neotech' ),
			'type' => Controls_Manager::NUMBER,
			'selector_value' => 'display:-webkit-box;-webkit-box-orient:vertical;overflow:hidden;-webkit-line-clamp:{{VALUE}};',
		];

		$fields['font_weight'] = [
			'label' => esc_html_x( 'Weight', 'Typography Control', 'neotech' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'100' => '100 ' . esc_html_x( '(Thin)', 'Typography Control', 'neotech' ),
				'200' => '200 ' . esc_html_x( '(Extra Light)', 'Typography Control', 'neotech' ),
				'300' => '300 ' . esc_html_x( '(Light)', 'Typography Control', 'neotech' ),
				'400' => '400 ' . esc_html_x( '(Normal)', 'Typography Control', 'neotech' ),
				'500' => '500 ' . esc_html_x( '(Medium)', 'Typography Control', 'neotech' ),
				'600' => '600 ' . esc_html_x( '(Semi Bold)', 'Typography Control', 'neotech' ),
				'700' => '700 ' . esc_html_x( '(Bold)', 'Typography Control', 'neotech' ),
				'800' => '800 ' . esc_html_x( '(Extra Bold)', 'Typography Control', 'neotech' ),
				'900' => '900 ' . esc_html_x( '(Black)', 'Typography Control', 'neotech' ),
				'' => esc_html__( 'Default', 'neotech' ),
				'normal' => esc_html__( 'Normal', 'neotech' ),
				'bold' => esc_html__( 'Bold', 'neotech' ),
			],
		];

		$fields['text_transform'] = [
			'label' => esc_html_x( 'Transform', 'Typography Control', 'neotech' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => esc_html__( 'Default', 'neotech' ),
				'uppercase' => esc_html_x( 'Uppercase', 'Typography Control', 'neotech' ),
				'lowercase' => esc_html_x( 'Lowercase', 'Typography Control', 'neotech' ),
				'capitalize' => esc_html_x( 'Capitalize', 'Typography Control', 'neotech' ),
				'none' => esc_html__( 'Normal', 'neotech' ),
			],
		];

		$fields['font_style'] = [
			'label' => esc_html_x( 'Style', 'Typography Control', 'neotech' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => esc_html__( 'Default', 'neotech' ),
				'normal' => esc_html__( 'Normal', 'neotech' ),
				'italic' => esc_html_x( 'Italic', 'Typography Control', 'neotech' ),
				'oblique' => esc_html_x( 'Oblique', 'Typography Control', 'neotech' ),
			],
		];

		$fields['text_decoration'] = [
			'label' => esc_html_x( 'Decoration', 'Typography Control', 'neotech' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => esc_html__( 'Default', 'neotech' ),
				'underline' => esc_html_x( 'Underline', 'Typography Control', 'neotech' ),
				'overline' => esc_html_x( 'Overline', 'Typography Control', 'neotech' ),
				'line-through' => esc_html_x( 'Line Through', 'Typography Control', 'neotech' ),
		...
		$fields['letter_spacing'] = [
			'label' => esc_html__( 'Letter Spacing', 'neotech' ),
			'type' => Controls_Manager::SLIDER,
			'size_units' => [ 'px', 'em', 'rem', 'custom' ],
			'range' => [
				'px' => [
		...
		$fields['word_spacing'] = [
			'label' => esc_html__( 'Word Spacing', 'neotech' ),
			'type' => Controls_Manager::SLIDER,
			'size_units' => [ 'px', 'em', 'rem', 'custom' ],
			'range' => [
				'px' => [
	...
	protected function get_default_options() {
		return [
			'popover' => [
				...
				'starter_title' => esc_html__( 'Typography', 'neotech' ),
				'settings' => [
					'render_type' => 'ui',
