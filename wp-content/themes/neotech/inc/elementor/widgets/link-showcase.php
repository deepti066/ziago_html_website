 ...
 * @since 1.0.0
 */
class Neotech_Elementor_Link_Showcase extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Neotech Link Showcase', 'neotech');
    }
    ...
    public function get_script_depends() {
        return ['neotech-elementor-link-showcase'];
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'     => esc_html__('Title', 'neotech'),
                'placeholder' => esc_html__('Title', 'neotech'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'number',
            [
                'label'     => esc_html__('Number', 'neotech'),
                'type'      => Controls_Manager::NUMBER,
                'default'     => esc_html__('Number', 'neotech'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_responsive_control(
            'text-horizontal',
            [
                'label'      => esc_html__('Position Horizontal', 'neotech'),
        ...
        $repeater->add_control(
            'image_style',
            [
                'label'     => esc_html__('Image Style', 'neotech'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'single',
                'render_type'        => 'template',
                'options'   => [
                    'single'  => esc_html__('Single Image', 'neotech'),
                    'multiple'  => esc_html__('Multiple Images', 'neotech'),
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'title'    => esc_html__('Title #1', 'neotech'),
                        'subtitle' => esc_html__('Subtitle #1', 'neotech'),
                        'link'     => esc_html__('#', 'neotech'),
                    ],
                    [
                        'title'    => esc_html__('Title #2', 'neotech'),
                        'subtitle' => esc_html__('Subtitle #2', 'neotech'),
                        'link'     => esc_html__('#', 'neotech'),
                    ],
                ],
                'title_field' => '{{{ title }}}',
        ...
        $this->add_control(
            'number_color',
            [
                'label'     => esc_html__('Number Color', 'neotech'),
                'type'      => Controls_Manager::COLOR,
                'global'    => [
                    'default' => Global_Colors::COLOR_PRIMARY,
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'label'     => esc_html__('Image 1', 'neotech'),
                'separator' => 'none',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'type'      => Controls_Manager::HEADING,
                'label'     => esc_html__('Image 2', 'neotech'),
                'separator' => 'before',
            ]
        );
...
$widgets_manager->register(new Neotech_Elementor_Link_Showcase());
