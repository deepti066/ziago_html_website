...
/**
 * Elementor Neotech_Elementor_Tabs_Target
 * @since 1.0.0
 */
class Neotech_Elementor_Tabs_Target extends Neotech_Base_Widgets {
    ...
    public function get_title() {
        return esc_html__('Neotech Tabs Target', 'neotech');
    }
    ...
    public function get_script_depends() {
        return ['neotech-elementor-tabs-target'];
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'description' => __('Add Target ID (CSS ID in Advanced tab setting of Target) WITHOUT the Pound key. e.g: my-id', 'neotech')
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'tab_title' => esc_html__( 'Tab #1', 'neotech' ),
                    ],
                    [
                        'tab_title' => esc_html__( 'Tab #2', 'neotech' ),
                    ],
                ],
        ...
        $this->add_responsive_control( 'tabs_direction', [
			...
			'options' => [
				'row' => [
                    'title' => esc_html__( 'Row - horizontal', 'neotech' ),
                    'icon' => 'eicon-navigation-horizontal',
                ],
				'column' => [
                    'title' => esc_html__( 'Column - vertical', 'neotech' ),
        ...
        $this->add_responsive_control( 'tabs_justify', [
			'label' => esc_html__( 'Justify', 'neotech' ),
			'type' => Controls_Manager::CHOOSE,
			'options' => [
				'flex-start' => [
					'title' => esc_html__( 'Start', 'neotech' ),
				...
				'flex-end' => [
					'title' => esc_html__( 'End', 'neotech' ),
					'icon' => 'eicon-flex eicon-justify-end-h',
				],
				'space-between' => [
					'title' => esc_html__( 'Space Between', 'neotech' ),
        ...
        $this->add_responsive_control( 'tabs_align', [
			'label' => esc_html__( 'Align', 'neotech' ),
			'type' => Controls_Manager::CHOOSE,
			'options' => [
				'flex-start' => [
					'title' => esc_html__( 'Start', 'neotech' ),
        ...
        $this->add_responsive_control( 'tabs_spacing', [
			'label' => esc_html__( 'Tabs Gap', 'neotech' ),
        ...
        $this->start_controls_section(
            'wrapper_style',
            [
                'label' => esc_html__('Button Tabs', 'neotech'),
...
$widgets_manager->register(new Neotech_Elementor_Tabs_Target());
