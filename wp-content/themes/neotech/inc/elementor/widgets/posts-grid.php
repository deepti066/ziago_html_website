...
/**
 * Class Neotech_Elementor_Blog
 */
class Neotech_Elementor_Post_Grid extends Neotech_Base_Widgets {

    public function get_name() {
        return 'neotech-post-grid';
    }

    public function get_title() {
        return esc_html__('Posts Grid', 'neotech');
    }
    ...
    public function get_script_depends() {
        return ['neotech-elementor-posts-grid'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_query',
            [
                'label' => esc_html__('Query', 'neotech'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'post_date',
                'options' => [
                    'post_date'  => esc_html__('Date', 'neotech'),
                    'post_title' => esc_html__('Title', 'neotech'),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'post-style-1' => esc_html__('Style 1', 'neotech'),
                    'post-style-2' => esc_html__('Style 2', 'neotech'),
                ],
...
$widgets_manager->register(new Neotech_Elementor_Post_Grid());