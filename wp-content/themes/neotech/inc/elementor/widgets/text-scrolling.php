 ...
 * @since 1.0.0
 */
class Neotech_Elementor_Text_Scrolling extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Neotech Text Scrolling', 'neotech');
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'scrolling_title',
            [
                'label'       => esc_html__('Scrolling name', 'neotech'),
                'type'        => Controls_Manager::TEXT,
                'placeholder' => esc_html__('Scrolling Name', 'neotech'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_responsive_control(
            'duration',
            [
                'label'     => esc_html__('Scrolling duration', 'neotech'),
        ...
        $repeater->add_control(
            'text_stroke',
            [
                'label'     => esc_html__('Text Stroke', 'neotech'),
        ...
        $repeater->add_responsive_control(
            'width',
            [
                'label'      => esc_html__('Width Stroke', 'neotech'),
        ...
        $repeater->add_control(
            'color_stroke',
            [
                'label'     => esc_html__('Color Stroke', 'neotech'),
...
'{{WRAPPER}} .elementor-scrolling-wrapper .elementor-scrolling-item'  => 'margin-left: calc({{SIZE}}{{UNIT}}/2); margin-right: calc({{SIZE}}{{UNIT}}/2);',
        ...
        $this->add_control(
            'border_style',
            [
                'label'        => esc_html__('Border', 'neotech'),
                'type'         => Controls_Manager::SWITCHER,
                'default'      => '',
        ...
        $this->add_control(
            'stroke-style',
            [
                'label'        => esc_html__('Stroke style', 'neotech'),
                'type'         => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'color_icon_space',
            [
                'label'     => esc_html__('Icon Space Color', 'neotech'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
...
$widgets_manager->register(new Neotech_Elementor_Text_Scrolling());
