...
class Neotech_Elementor_Banner_Carousel extends Neotech_Base_Widgets {
    ...
    public function get_name() {
        return 'neotech-banner-carousel';
    }
    ...
    public function get_title() {
        return esc_html__('Neotech Banner Carousel', 'neotech');
    }
    ...
    public function get_script_depends() {
        return ['neotech-elementor-banner-carousel'];
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Image Carousel', 'neotech'),
            ]
        );
            ...
            $repeater->add_control(
                'image_side',
                [
                    'label'   => esc_html__('Show Image Side', 'neotech'),
                    'default' => 'no',
            ...
            $repeater->add_control(
                ...
                [
                    'label'      => esc_html__('Choose Image Side', 'neotech'),
                    'default'    => [
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'label_block' => true,
                    'placeholder' => esc_html__('Button', 'neotech'),
                    'default'     => esc_html__('Button', 'neotech'),
                    'condition'   => [
            ...
            $repeater->add_control(
                'image_button_link',
                [
                    'label'       => esc_html__('Button Link', 'neotech'),
                    'type'        => Controls_Manager::URL,
                    'placeholder' => esc_html__('https://your-link.com', 'neotech'),
                    'default'     => [
                        'url' => '#',
            ...
            $this->add_control(
                'box-image-height',
                [
                    'label'        => esc_html__('Box Image Height', 'neotech'),
                    'type'         => Controls_Manager::SELECT,
                    'default'      => 'auto',
                    'options'      => [
                        'auto' => __('Auto', 'neotech'),
                        'full' => __('Full', 'neotech'),
                    ],
            ...
            $this->add_responsive_control(
                'image_inline_title',
                [
                    'label'       => esc_html__('Inline Title', 'neotech'),
                    'type'    => Controls_Manager::SWITCHER,
                    'selectors_dictionary' => [
                        'yes' => 'inline',
                        'no' => 'block',
        ...
        $this->start_controls_section(
            'banner_style',
            [
                'label' => esc_html__('Banner Image', 'neotech'),
            ...
            $this->add_control(
                ...
                [
                    ...
                    'label'     => esc_html__('Box Side Image', 'neotech'),
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'      => esc_html__('Image Width', 'neotech'),
            ...
            $this->add_control(
                ...
                [
                    'type'      => Controls_Manager::HEADING,
                    'label'     => esc_html__('Box Image', 'neotech'),
                    'separator'    => 'before',
                ]
            );
        ...
        $this->start_controls_section(
            'box_text_style',
            [
                'label' => esc_html__('Box Text', 'neotech'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
            ...
            $this->add_control(
                ...
                [
                    'type'      => Controls_Manager::HEADING,
                    'label'     => esc_html__('Box Position', 'neotech'),
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'type'      => Controls_Manager::HEADING,
                    'label'     => esc_html__('Box Title', 'neotech'),
                    'separator' => 'before',
                ]
            );
        ...
        $this->add_control(
            'title_color_hover',
            [
                'label'     => esc_html__('Title Color Hover', 'neotech'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'type'      => Controls_Manager::HEADING,
                    'label'     => esc_html__('Box description', 'neotech'),
                    'separator' => 'before',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'type'      => Controls_Manager::HEADING,
                    'label'     => esc_html__('Box Button', 'neotech'),
                    'separator' => 'before',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Button Background Color', 'neotech'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Button Hover Background Color', 'neotech'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Button Text Color', 'neotech'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => esc_html__('Button Hover Text Color', 'neotech'),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label' => esc_html__( 'Button Margin', 'neotech' ),
                    'type'       => Controls_Manager::DIMENSIONS,
                    'size_units' => ['px', 'em', '%'],
                    'selectors'  => [
...
$widgets_manager->register(new Neotech_Elementor_Banner_Carousel());
