...
if (!neotech_is_mailchimp_activated()) {
    return;
}
...
class Neotech_Elementor_Mailchimp extends Elementor\Widget_Base
{

    public function get_name()
    {
        return 'neotech-mailchmip';
    }

    public function get_title()
    {
        return esc_html__('MailChimp Sign-Up Form', 'neotech');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '1',
                'options' => [
                    '1' => esc_html__('Layout 1', 'neotech'),
                    '2' => esc_html__('Layout 2', 'neotech'),
                    '3' => esc_html__('Default', 'neotech'),
                ],
        ...
        $this->start_controls_section(
            'form_group',
            [
                'label' => esc_html__('Form Group', 'neotech'),
        ...
        $this->add_control(
            ...
            [
                'label'        => esc_html__('Hidden form checkbox', 'neotech'),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'prefix_class' => 'hidden-neotech-form-checkbox-'
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Input', 'neotech'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Placeholder', 'neotech'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'input_color_border',
            [
                'label' => esc_html__('Color Border', 'neotech'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_tab(
            'tab_input_focus',
            [
                'label' => esc_html__('Focus', 'neotech'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Icon Border Color hover', 'neotech'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
...
$widgets_manager->register(new Neotech_Elementor_Mailchimp());
