...
class Neotech_Pricing extends Elementor\Widget_Base {

    public function get_name() {
        return 'neotech-pricing';
    }

    public function get_title() {
        return esc_html__('Neotech Pricing', 'neotech');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_header',
            [
                'label' => esc_html__('Header', 'neotech'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Enter your title', 'neotech'),
                'dynamic' => [
                    'active' => true,
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__('Enter your description', 'neotech'),
                'dynamic' => [
                    'active' => true,
                ],
            ]
        ...
        $this->start_controls_section(
            'section_pricing',
            [
                'label' => esc_html__('Pricing', 'neotech'),
            ]
        );
        ...
        $this->add_control(
            'currency_symbol',
            [
                'label'   => esc_html__('Currency Symbol', 'neotech'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    ''             => esc_html__('None', 'neotech'),
                    'dollar'       => '&#36; ' . _x('Dollar', 'Currency', 'neotech'),
                    'euro'         => '&#128; ' . _x('Euro', 'Currency', 'neotech'),
                    'baht'         => '&#3647; ' . _x('Baht', 'Currency', 'neotech'),
                    'franc'        => '&#8355; ' . _x('Franc', 'Currency', 'neotech'),
                    'guilder'      => '&fnof; ' . _x('Guilder', 'Currency', 'neotech'),
                    'krona'        => 'kr ' . _x('Krona', 'Currency', 'neotech'),
                    'lira'         => '&#8356; ' . _x('Lira', 'Currency', 'neotech'),
                    'peseta'       => '&#8359 ' . _x('Peseta', 'Currency', 'neotech'),
                    'peso'         => '&#8369; ' . _x('Peso', 'Currency', 'neotech'),
                    'pound'        => '&#163; ' . _x('Pound Sterling', 'Currency', 'neotech'),
                    'real'         => 'R$ ' . _x('Real', 'Currency', 'neotech'),
                    'ruble'        => '&#8381; ' . _x('Ruble', 'Currency', 'neotech'),
                    'rupee'        => '&#8360; ' . _x('Rupee', 'Currency', 'neotech'),
                    'indian_rupee' => '&#8377; ' . _x('Rupee (Indian)', 'Currency', 'neotech'),
                    'shekel'       => '&#8362; ' . _x('Shekel', 'Currency', 'neotech'),
                    'yen'          => '&#165; ' . _x('Yen/Yuan', 'Currency', 'neotech'),
                    'won'          => '&#8361; ' . _x('Won', 'Currency', 'neotech'),
                    'custom'       => esc_html__('Custom', 'neotech'),
                ],
                'default' => 'dollar',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Custom Symbol', 'neotech'),
                'type'      => Controls_Manager::TEXT,
                'condition' => [
        ...
        $this->add_control(
            'price',
            [
                'label'   => esc_html__('Price', 'neotech'),
                'type'    => Controls_Manager::TEXT,
                'default' => '39.99',
                'dynamic' => [
                    'active' => true,
        ...
        $this->add_control(
            'currency_format',
            [
                'label'   => esc_html__('Currency Format', 'neotech'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    ''  => '1,234.56 (Default)',
                    ',' => '1.234,56',
        ...
        $this->add_control(
            'original_price',
            [
                'label'     => esc_html__('Original Price', 'neotech'),
        ...
        $this->add_control(
            'period',
            [
                'label'   => esc_html__('Period', 'neotech'),
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__('Monthly', 'neotech'),
            ]
        );
        ...
        $this->start_controls_section(
            'section_features',
            [
                'label' => esc_html__('Features', 'neotech'),
            ]
        );
        ...
        $repeater->add_control(
            'item_text',
            [
                'label'   => esc_html__('Text', 'neotech'),
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__('List Item', 'neotech'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'item_text'          => esc_html__('List Item #1', 'neotech'),
                        'selected_item_icon' => $default_icon,
                    ],
                    [
                        'item_text'          => esc_html__('List Item #2', 'neotech'),
                        'selected_item_icon' => $default_icon,
                    ],
                    [
                        'item_text'          => esc_html__('List Item #3', 'neotech'),
                        'selected_item_icon' => $default_icon,
                    ],
                ],
        ...
        $this->start_controls_section(
            'section_footer',
            [
                'label' => esc_html__('Footer', 'neotech'),
            ]
        );
        ...
        $this->add_control(
            'border_hover_color',
            [
                'label'     => esc_html__('Border Hover', 'neotech'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'before' => [
                        'title' => esc_html__('Before', 'neotech'),
                        'icon'  => 'eicon-h-align-left',
                    ],
                    'after'  => [
                        'title' => esc_html__('After', 'neotech'),
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => false,
                'options'     => [
                    'below'  => esc_html__('Below', 'neotech'),
                    'beside' => esc_html__('Beside', 'neotech'),
                ],
                'default'     => 'below',
                'condition'   => [
                    'period!' => '',
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => 'md',
                'options'   => [
                    'xs' => esc_html__('Extra Small', 'neotech'),
                    'sm' => esc_html__('Small', 'neotech'),
                    'md' => esc_html__('Medium', 'neotech'),
                    'lg' => esc_html__('Large', 'neotech'),
                    'xl' => esc_html__('Extra Large', 'neotech'),
                ],
                'condition' => [
                    'button_text!' => '',
                ],
        ...
        $this->add_control(
            'button_text_padding',
            [
                'label'      => esc_html__('Button Padding', 'neotech'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
...
$widgets_manager->register(new Neotech_Pricing());
