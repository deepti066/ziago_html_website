 ...
 * @since 1.0.0
 */
class Neotech_Widget_Button extends Widget_Base
{
    ...
    {
        return esc_html__('Neotech Button', 'neotech');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'icon_indent',
            [
                'label' => esc_html__('Icon Spacing', 'neotech'),
        ...
        $this->add_control(
            'button_css_id',
            [
                'label' => esc_html__('Button ID', 'neotech'),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
                'default' => '',
                'title' => esc_html__('Add your custom id WITHOUT the Pound key. e.g: my-id', 'neotech'),
                /* translators: %1$s Code open tag, %2$s: Code close tag. */
                'description' => esc_html__('Please make sure the ID is unique and not used elsewhere on the page this form is displayed. This field allows <code>A-z 0-9</code> & underscore chars without spaces.', 'neotech'),
                'separator' => 'before',
                'condition' => $args['section_condition'],
            ]
        );
...
$widgets_manager->register(new Neotech_Widget_Button());
