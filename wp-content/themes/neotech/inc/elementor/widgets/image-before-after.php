...
class Neotech_Elementor_Image_Before_After extends Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'neotech-image-before-after';
    }
    ...
    public function get_title() {
        return esc_html__('Neotech Image Before After', 'neotech');
    }
    ...
    public function get_script_depends() {
        return ['neotech-elementor-image-before-after', 'beforeafter'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'image_before',
            [
                'label'      => esc_html__('Choose Image Before', 'neotech'),
                'default'    => [
        ...
        $this->add_control(
            'image_after',
            [
                'label'      => esc_html__('Choose Image After', 'neotech'),
                'default'    => [
                    'url' => Elementor\Utils::get_placeholder_image_src(),
                ],
                'type'       => Controls_Manager::MEDIA,
...
$widgets_manager->register(new Neotech_Elementor_Image_Before_After());
