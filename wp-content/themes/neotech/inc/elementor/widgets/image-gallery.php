 ...
 * @since 1.0.0
 */
class Neotech_Elementor_Image_Gallery extends Neotech_Base_Widgets {
    ...
    public function get_title() {
        return esc_html__('Neotech Image Gallery', 'neotech');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_gallery',
            [
                'label' => esc_html__('Image Gallery', 'neotech'),
            ]
        );
        ...
        $repeater->add_control(
            'filter_title',
            [
                'label'       => esc_html__('Filter Title', 'neotech'),
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => esc_html__('List Item', 'neotech'),
        ...
        $repeater->add_control(
            'wp_gallery',
            [
                'label'      => esc_html__('Add Images', 'neotech'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'filter_title' => esc_html__('Gallery 1', 'neotech'),
                    ],
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'options'      => [
                    ...
                    'masonry' => esc_html__('Masonry', 'neotech'),
                ],
                'prefix_class' => 'neotech-image-gallery-'
            ]
        );
        ...
        $this->add_control(
            'show_filter_bar',
            [
                'label'     => esc_html__('Filter Bar', 'neotech'),
...
//                    '(widescreen){{WRAPPER}} .grid__item'   => 'width: calc((100% - {{column_spacing.SIZE}}{{column_spacing.UNIT}}*({{column_widescreen.VALUE}} - 1)) / {{column_widescreen.VALUE}})',
        ...
        $this->add_responsive_control(
            'filter_item_spacing',
            [
                'label'     => esc_html__('Space Between', 'neotech'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'filter_padding',
            [
                'label'      => esc_html__('Filter Padding', 'neotech'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em'],
                'range'      => [
                    'px' => [
    ...
    protected function render() {
        ...
        $this->add_render_attribute('wrapper', 'class', 'elementor-neotech-image-gallery');
        ...
        if ($settings['show_filter_bar'] == 'yes') :
            ...
            <ul class="elementor-galerry__filters" data-related="isotope-<?php echo esc_attr($this->get_id()); ?>">
                <li class="elementor-galerry__filter elementor-active" data-filter=".gallery_group_all"><?php echo esc_html__('Show All', 'neotech'); ?>
                ...
                <?php foreach ($image_gallery as $index => $item) {
                    ...
                    <div class="grid__item gallery_group_all <?php echo 'gallery_group_' . esc_attr($item['group']); ?>">
                        <a <?php $this->print_render_attribute_string($link_content_setting_key); ?> href="<?php echo esc_url($image_url_full); ?>">
                            <img class="neotech-elementor-src-gallery" src="<?php echo esc_url($image_url); ?>" alt="<?php echo esc_attr(Elementor\Control_Media::get_image_alt($item)); ?>"/>
                        </a>
                    </div>
                <?php } ?>
            </div>
...
$widgets_manager->register(new Neotech_Elementor_Image_Gallery());