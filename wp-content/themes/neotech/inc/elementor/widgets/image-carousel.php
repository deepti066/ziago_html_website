...
class Neotech_Elementor_Image_Carousel extends Neotech_Base_Widgets {
    ...
    public function get_title() {
        return esc_html__('Neotech Image Carousel', 'neotech');
    }
    ...
    public function get_script_depends() {
        return ['neotech-elementor-image-carousel'];
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'target_link',
            [
                'label'   => esc_html__('Target', 'neotech'),
                'default' => 'yes',
        ...
        $this->add_control(
            'smoot_carousel',
            [
                'label'        => esc_html__('Smooth Carousel', 'neotech'),
                'type'         => Controls_Manager::SWITCHER,
        ...
        $this->add_responsive_control('image_height',
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}}.elementor-widget-neotech-image-carousel a img' => 'height: {{SIZE}}{{UNIT}};object-fit: cover; '
                ]
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default'      => '',
                'selectors'    => [
                    '{{WRAPPER}}.elementor-widget-neotech-image-carousel a' => 'text-align: {{VALUE}}',
                ],
            ]
       );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'placeholder' => '1px',
                'default'     => '1px',
                'selector'    => '{{WRAPPER}}.elementor-widget-neotech-image-carousel a img',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}}.elementor-widget-neotech-image-carousel a img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}}.elementor-widget-neotech-image-carousel a img' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}}.elementor-widget-neotech-image-carousel a:hover img' => 'border-color: {{VALUE}}',
                ],
            ]
        );
         ...
         $this->add_control(
            ...
            [
                'label'        => __('Up Down', 'neotech'),
                'type'         => Controls_Manager::SELECT,
                'options'      => [
                    ''       => __('Default', 'neotech'),
                    'custom' => __('Custom', 'neotech'),
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => __('Image Up Down', 'neotech'),
                'type'       => Controls_Manager::SLIDER,
                'show_label' => false,
                'range'      => [
                    'px' => [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .neotech-con:not(.cloned) .neotech-con-inner > div:nth-last-child(2n-2)' => 'margin-top: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .neotech-con:not(.cloned) .neotech-con-inner > div:nth-last-child(2n-1)' => 'margin-bottom: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .cloned .neotech-con-inner > div:nth-last-child(2n-1)' => 'margin-top: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .cloned .neotech-con-inner > div:nth-last-child(2n-2)' => 'margin-bottom: {{SIZE}}{{UNIT}}',
                ],
                'condition'  => [
...
$widgets_manager->register(new Neotech_Elementor_Image_Carousel());
