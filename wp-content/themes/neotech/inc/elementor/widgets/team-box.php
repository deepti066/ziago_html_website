...
class Neotech_Elementor_Team_Box extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Team Box', 'neotech');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'teams',
            [
                'label' => esc_html__('Team Item', 'neotech'),
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => esc_html__('https://www.facebook.com/themelexus', 'neotech'),
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => esc_html__('https://twitter.com/themelexus', 'neotech'),
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => esc_html__('https://www.pinterest.com/', 'neotech'),
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => esc_html__('https://www.youtube.com/', 'neotech'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Icon Social', 'neotech'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
                    ...
                    <?php if (!empty($settings[$key])) : ?>
                        <li class="social">
                            <a href="<?php echo esc_url($settings[$key]) ?>">
                                <i class="neotech-icon-<?php echo esc_attr($social); ?>"></i>
                            </a>
                        </li>
                    <?php endif; ?>
                <?php endforeach; ?>
...
$widgets_manager->register(new Neotech_Elementor_Team_Box());
