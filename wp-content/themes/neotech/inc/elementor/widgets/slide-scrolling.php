 ...
 * @since 1.0.0
 */
class Neotech_Elementor_Slide_Scrolling extends Neotech_Base_Widgets {
    ...
    public function get_name() {
        return 'neotech-slide-scrolling';
    }
    ...
    public function get_title() {
        return esc_html__('Neotech Slide Scrolling', 'neotech');
    }
    /**
     * Get widget icon.
     *
    ...
    public function get_script_depends() {
        return ['neotech-elementor-slide-scrolling','tweenmax'];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'      => '',
                'prefix_class' => 'neotech-scrolling-border-'
            ]
        );
...
$widgets_manager->register(new Neotech_Elementor_Slide_Scrolling());
