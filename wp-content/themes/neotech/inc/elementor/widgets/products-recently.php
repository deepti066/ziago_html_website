 ...
 * @since 1.0.0
 */
class Neotech_Elementor_Widget_Products_Recently extends \Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'neotech-products-recently';
    }
    ...
    public function get_title() {
        return esc_html__('Products Recently', 'neotech');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            'product_gutter',
            [
                'label'      => esc_html__('Gutter', 'neotech'),
    ...
    protected function render() {
        ...
        if (empty($viewed_products)) {
            echo '<p class="recently-notice">' . esc_html__('There’s no item that you viewed recently.', 'neotech') . '</p>';
            return;
        }
...
$widgets_manager->register(new Neotech_Elementor_Widget_Products_Recently());
