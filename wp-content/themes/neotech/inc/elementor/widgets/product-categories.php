...
/**
 * Elementor Neotech_Elementor_Products_Categories
 * @since 1.0.0
 */
class Neotech_Elementor_Products_Categories extends Neotech_Base_Widgets {
    ...
    public function get_name() {
        return 'neotech-product-categories';
    }
    ...
    public function get_title() {
        return esc_html__('Neotech Product Categories', 'neotech');
    }
    ...
    public function get_script_depends() {
        return ['neotech-elementor-product-categories'];
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'categories_name',
            [
                'label' => esc_html__('Alternate Name', 'neotech'),
        ...
        $this->add_control('show_count',
            [
                'label' => esc_html__('Show Count', 'neotech'),
        ...
        $this->end_controls_tabs();
         ...
         $this->add_responsive_control(
            'effects_width',
            [
                'label'          => esc_html__('Width Effects', 'neotech'),
                'type'           => Controls_Manager::SLIDER,
                'default'        => [
                    'unit' => '%',
                ],
        ...
        $this->end_controls_section();
         ...
         $this->add_responsive_control(
          ...
          $this->add_control(
              'icon_color_hover',
              [
                  'label'     => esc_html__('Hover Color', 'neotech'),
                  'type'      => Controls_Manager::COLOR,
                  'default'   => '',
                  'selectors' => [
        ...
        $this->add_responsive_control('box_text_horizontal_position',
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}}.category-product-style-4 .neotech-con .neotech-con-inner' => 'left: {{SIZE}}{{UNIT}}'
                ],
                'condition' => [
                    'style' => '4'
                ]
        ...
        $this->add_responsive_control('box_text_vertical_position',
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}}.category-product-style-4 .neotech-con .neotech-con-inner' => 'top: {{SIZE}}{{UNIT}}'
                ],
                'condition' => [
                    'style' => '4'
                ]
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}}.elementor-widget-neotech-product-categories .category-title a:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            'total_style',
            [
                'label' => esc_html__('Total', 'neotech'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'total_color_text',
            [
                'label'     => esc_html__('Color Count Text', 'neotech'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'total_color',
            [
                'label'     => esc_html__('Color Count', 'neotech'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
                        ...
                        <?php foreach ($settings['categories_list'] as $index => $item): ?>
                            ...
                            <div <?php $this->print_render_attribute_string('item'); ?>>
                                <?php if (empty($item['categories'])) {
                                    echo esc_html__('Choose Category', 'neotech');
                                    return;
                                }
                                                    ...
                                                    <div class="category-product-top-info">
                                                        ...
                                                        <?php if ($settings['show_count']): ?>
                                                            <div class="category-count-wrapper">
                                                                ...
                                                                <span class="category-count-text"><?php echo esc_html__('products', 'neotech') ?></span>
                                                            </div>
                                                        <?php endif; ?>
                                                    </div>
                                                ...
                                                <div class="category-product-button-wrapper ">
                                                    <a class="elementor-button elementor-button-link" data-text="<?php echo esc_html($settings['category_button_text']) ?>"
                                                       href="<?php echo esc_url(get_term_link($category)); ?>">
                                                        ...
                                                        <span><i class="neotech-icon-arrow-long-right"></i></span>
                                                    </a>
...
$widgets_manager->register(new Neotech_Elementor_Products_Categories());
