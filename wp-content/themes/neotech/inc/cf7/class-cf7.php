    ...
    class Neotech_CF7 {
        ...
        public function wpcf7_time_messages( $messages ) {
            return array_merge( $messages, array(
                'invalid_time' => array(
                    'description' => __( "Date format that the sender entered is invalid", 'neotech' ),
                    'default' => __( "Please enter a date in YYYY-MM-DD format.", 'neotech' ),
                ),
            ) );
        }
        ...
        public function wpcf7_tag_generator_time( $contact_form, $args = '' ) {
            ...
            $description = __( "Generate a form-tag for a time input field", 'neotech' );
                ...
                <fieldset>
                    ...
                    <table class="form-table">
                        <tbody>
                            ...
                            <tr>
                                <th scope="row"><label for="<?php echo esc_attr( $args['content'] . '-values' ); ?>"><?php echo esc_html( __( 'Default value', 'neotech' ) ); ?></label></th>
